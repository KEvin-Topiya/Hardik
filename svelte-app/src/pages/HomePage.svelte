<script>
  ...
  import { getProducts, getHeroImages } from "../services/api";
  ...
  onMount(async () => {
    ...
    try {
      const imagesData = await getHeroImages();
...
<SEO
  ...
  keywords="Aarti Abhushan, premium jewelry, gold rings, diamond necklaces, platinum jewelry, indian heritage jewelry, luxury ornaments"
/>
